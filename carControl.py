...
class CarControl(object):
    ...
    def toMsg(self):
        ...
        with open('actions.csv', 'a', newline='') as f_obj:
            writer_obj = writer(f_obj)
            li = [self.actions['accel'][0], self.actions['brake'][0], self.actions['gear'][0], self.actions['steer'][0], self.actions['clutch'][0], self.actions['focus'][0], self.actions['meta'][0]]
